...
const ITEM_INFO: Record<string, CampaignItemInfo> = {
  'heavy-ball': { name: 'Heavy Ball', icon: '●', iconPath: assetUrl('textures/pixel/items/heavy-ball-pixel-v1.png'), campaignUse: 'launch' },
  'metal-ball': { name: 'Metal Ball', icon: '◉', iconPath: assetUrl('textures/pixel/items/metal-ball-pixel-v1.png'), campaignUse: 'launch' },
  'small-ball': { name: 'Bouncy Ball', icon: '•', iconPath: assetUrl('textures/pixel/items/bouncy-ball-pixel-v1.png'), campaignUse: 'launch' },
  ball: { name: 'Bouncy Ball', icon: '•', iconPath: assetUrl('textures/pixel/items/bouncy-ball-pixel-v1.png'), campaignUse: 'launch' },
  'explosive-projectile': { name: 'Tank Shell', icon: '✦', iconPath: assetUrl('textures/pixel/items/explosive-projectile-pixel-v1.png'), campaignUse: 'launch' },
  rocket: { name: 'Rocket', icon: '▲', iconPath: assetUrl('textures/pixel/items/rocket-pixel-v1.png'), campaignUse: 'launch' },
  bomb: { name: 'Thrown Bomb', icon: '✹', iconPath: assetUrl('textures/pixel/items/bomb-pixel-v1.png'), campaignUse: 'launch' },
  'explosive-barrel': { name: 'Boom Barrel', icon: '▥', campaignUse: 'launch' },
  'concrete-block': { name: 'Concrete Chunk', icon: '◆', iconPath: assetUrl('textures/pixel/items/concrete-block-pixel-v1.png'), campaignUse: 'launch' },
  'metal-beam': { name: 'Metal Beam', icon: '┃' },
  spring: { name: 'Power Spring', icon: '≋', iconPath: assetUrl('textures/pixel/items/spring-pixel-v1.png') },
  rope: { name: 'Rope', icon: '⌁' },
  ...
  pistol: { name: 'Pistol Shot', icon: '⌐', iconPath: assetUrl('textures/pixel/weapons/pistol-pixel-v2.png'), campaignUse: 'firearm' },
  shotgun: { name: 'Shotgun Blast', icon: '═', iconPath: assetUrl('textures/pixel/weapons/shotgun-pixel-v2.png'), campaignUse: 'firearm' },
  rifle: { name: 'Rifle Round', icon: '╾', iconPath: assetUrl('textures/pixel/weapons/rifle-pixel-v2.png'), campaignUse: 'firearm' },
  knife: { name: 'Throwing Knife', icon: '▰', iconPath: assetUrl('textures/pixel/weapons/knife-pixel-v2.png'), campaignUse: 'launch' },
  machete: { name: 'Thrown Machete', icon: '▬', iconPath: assetUrl('textures/pixel/weapons/machete-pixel-v2.png'), campaignUse: 'launch' },
  axe: { name: 'Thrown Fire Axe', icon: '┫', iconPath: assetUrl('textures/pixel/weapons/axe-pixel-v2.png'), campaignUse: 'launch' },
  spear: { name: 'Thrown Spear', icon: '➤', iconPath: assetUrl('textures/pixel/weapons/spear-pixel-v2.png'), campaignUse: 'launch' },
};
...
const CATALOG: SpawnCatalogItem[] = [
  ...
  { id: 'concrete-block', name: 'Concrete Block', icon: '◆', iconPath: assetUrl('textures/pixel/items/concrete-block-pixel-v1.png'), category: 'Structures', description: 'Heavy and brittle.', lockedAfter: 1 },
  ...
  { id: 'ball', name: 'Bouncy Ball', icon: '●', iconPath: assetUrl('textures/pixel/items/bouncy-ball-pixel-v1.png'), category: 'Props', description: 'Rubber with ambition.' },
  { id: 'heavy-ball', name: 'Heavy Ball', icon: '◉', iconPath: assetUrl('textures/pixel/items/heavy-ball-pixel-v1.png'), category: 'Props', description: 'A portable bad decision.', lockedAfter: 1 },
  ...
  { id: 'knife', name: 'Utility Knife', icon: '▰', iconPath: assetUrl('textures/pixel/weapons/knife-pixel-v2.png'), category: 'Props', description: 'Compact physical blade. Select it, press F, then click to strike.', lockedAfter: 4 },
  { id: 'machete', name: 'Block Machete', icon: '▬', iconPath: assetUrl('textures/pixel/weapons/machete-pixel-v2.png'), category: 'Props', description: 'A heavy pixel blade with reach and real contact damage.', lockedAfter: 7 },
  { id: 'axe', name: 'Fire Axe', icon: '┫', iconPath: assetUrl('textures/pixel/weapons/axe-pixel-v2.png'), category: 'Props', description: 'Heavy directional chop with a physical box-built head and handle.', lockedAfter: 10 },
  { id: 'spear', name: 'Yard Spear', icon: '➤', iconPath: assetUrl('textures/pixel/weapons/spear-pixel-v2.png'), category: 'Props', description: 'Long reach, directional thrust, stable box collider.', lockedAfter: 11 },
  ...
  { id: 'spring', name: 'Power Spring', icon: '≋', iconPath: assetUrl('textures/pixel/items/spring-pixel-v1.png'), category: 'Machines', description: 'Stores and returns chaos.', lockedAfter: 5 },
  ...
  { id: 'bomb', name: 'Toy Bomb', icon: '✹', iconPath: assetUrl('textures/pixel/items/bomb-pixel-v1.png'), category: 'Destruction', description: 'A larger comic blast.', lockedAfter: 3 },
  { id: 'explosive-projectile', name: 'Tank Shell', icon: '✦', iconPath: assetUrl('textures/pixel/items/explosive-projectile-pixel-v1.png'), category: 'Destruction', description: 'A dense cannon round with a compact impact blast.', lockedAfter: 6 },
  { id: 'rocket', name: 'Rocket', icon: '▲', iconPath: assetUrl('textures/pixel/items/rocket-pixel-v1.png'), category: 'Destruction', description: 'Fast, loud, direction-ish.', lockedAfter: 9 },
  { id: 'giant-hammer', name: 'Giant Hammer', icon: 'Τ', category: 'Destruction', description: 'Subtlety sold separately.', lockedAfter: 2 },
  { id: 'pistol', name: 'Block Pistol', icon: '⌐', iconPath: assetUrl('textures/pixel/weapons/pistol-pixel-v2.png'), category: 'Destruction', description: '12-round physical sidearm. Select, press F, click a world point.', lockedAfter: 2 },
  { id: 'shotgun', name: 'Scattergun', icon: '═', iconPath: assetUrl('textures/pixel/weapons/shotgun-pixel-v2.png'), category: 'Destruction', description: 'Eight-pellet spread with restrained physical recoil.', lockedAfter: 5 },
  { id: 'rifle', name: 'Workshop Rifle', icon: '╾', iconPath: assetUrl('textures/pixel/weapons/rifle-pixel-v2.png'), category: 'Destruction', description: 'Fast, accurate semi-auto physics rifle.', lockedAfter: 8 },
];
...
export class Game {
  ...
  constructor(root: HTMLElement) {
    ...
    this.locale = installRussianLocale(root);
  ...
  private async initialize(): Promise<void> {
    ...
    this.locale.setLanguage(platformService.getLanguage() ?? undefined);
