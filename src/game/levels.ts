...
export const LEVELS: LevelDefinition[] = [
  ...
  },
  {
    ...
    chapterName: 'Backyard Mayhem',
    name: 'Bad Foundation',
    subtitle: 'A tall stack, three stone balls, and one concrete chunk.',
    description: 'Launch the concrete chunk through a footing or hit either red blast pocket to fold the occupied tower sideways.',
    thumbnail: {
